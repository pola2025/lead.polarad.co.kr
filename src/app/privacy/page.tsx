    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-md mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
          ...
          <p className="text-xs text-gray-500 mb-6">시행일: 2025년 1월 1일</p>
          ...
          <div className="text-sm leading-relaxed">
            ...
            <section className="mb-6">
              <h2 className="text-base font-semibold text-gray-900 mb-2">제1조 (개인정보의 수집 항목)</h2>
            ...
            <section className="mb-6">
              <h2 className="text-base font-semibold text-gray-900 mb-2">제2조 (개인정보의 수집 및 이용 목적)</h2>
              <p className="text-gray-700 mb-2">회사는 수집한 개인정보를 다음의 목적을 위해 이용합니다.</p>
              <ul className="list-disc list-inside text-gray-600 space-y-0.5 mt-2 text-xs">
                <li>상담 신청 접수 및 처리</li>
            ...
            <section className="mb-6">
              <h2 className="text-base font-semibold text-gray-900 mb-2">제3조 (개인정보의 보유 및 이용 기간)</h2>
            ...
            <section className="mb-6">
              <h2 className="text-base font-semibold text-gray-900 mb-2">제4조 (개인정보의 제3자 제공)</h2>
              <p className="text-gray-700 mb-2 text-xs">
              ...
              <div className="bg-gray-50 rounded-lg p-3 mt-2 text-xs space-y-2">
                <div>
                  <p className="font-medium text-gray-800 mb-0.5">제공받는 자</p>
                  <p className="text-gray-600">상담 신청 시 선택한 서비스 제공 업체(클라이언트)</p>
                </div>
                <div>
                  <p className="font-medium text-gray-800 mb-0.5">제공 목적</p>
                  <p className="text-gray-600">상담 진행 및 서비스 제공</p>
                </div>
                <div>
                  <p className="font-medium text-gray-800 mb-0.5">제공 항목</p>
                  <p className="text-gray-600">이름, 연락처, 이메일 등 상담 신청 시 입력한 정보</p>
                </div>
              </div>
            </section>

            <section className="mb-6">
              <h2 className="text-base font-semibold text-gray-900 mb-2">제5조 (개인정보 처리의 위탁)</h2>
              <p className="text-gray-700 mb-2 text-xs">
                회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
              </p>
              <div className="bg-gray-50 rounded-lg p-3 mt-2 text-xs space-y-2">
                <div>
                  <p className="font-medium text-gray-800 mb-0.5">수탁업체</p>
                  <p className="text-gray-600">Amazon Web Services, Inc.</p>
                </div>
                <div>
                  <p className="font-medium text-gray-800 mb-0.5">위탁 업무</p>
            ...
            <section className="mb-6">
              <h2 className="text-base font-semibold text-gray-900 mb-2">제6조 (정보주체의 권리·의무 및 행사방법)</h2>
              <p className="text-gray-700 mb-2 text-xs">정보주체는 회사에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.</p>
              <ul className="list-disc list-inside text-gray-600 space-y-0.5 mt-2 text-xs">
                <li>개인정보 열람 요구</li>
            ...
            <section className="mb-6">
              <h2 className="text-base font-semibold text-gray-900 mb-2">제7조 (개인정보의 파기)</h2>
              <p className="text-gray-700 mb-2 text-xs">
                회사는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는
                지체없이 해당 개인정보를 파기합니다.
              </p>
              <div className="bg-gray-50 rounded-lg p-3 mt-2 text-xs">
                <p className="font-medium text-gray-800 mb-1">파기 방법</p>
                <ul className="list-disc list-inside text-gray-600 space-y-0.5">
            ...
            <section className="mb-6">
              <h2 className="text-base font-semibold text-gray-900 mb-2">제8조 (개인정보의 안전성 확보조치)</h2>
              <p className="text-gray-700 mb-2 text-xs">회사는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.</p>
              <ul className="list-disc list-inside text-gray-600 space-y-0.5 mt-2 text-xs">
            ...
            <section className="mb-6">
              <h2 className="text-base font-semibold text-gray-900 mb-2">제9조 (개인정보 보호책임자)</h2>
              <p className="text-gray-700 mb-2 text-xs">
              ...
              <div className="bg-blue-50 rounded-lg p-3 mt-2 border border-blue-200">
                <p className="font-semibold text-blue-900 mb-2 text-xs">개인정보 보호책임자</p>
            ...
            <section className="mb-6">
              <h2 className="text-base font-semibold text-gray-900 mb-2">제10조 (권익침해 구제방법)</h2>
              <p className="text-gray-700 mb-2 text-xs">
            ...
            <section className="mb-6">
              <h2 className="text-base font-semibold text-gray-900 mb-2">제11조 (개인정보 처리방침 변경)</h2>
            ...
            <section className="pt-4 border-t border-gray-200">
              <h2 className="text-base font-semibold text-gray-900 mb-2">사업자 정보</h2>
