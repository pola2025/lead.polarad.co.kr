...
export const CONSULTING_FORM_TEMPLATE: FormField[] = [
  ...
  },
  {
    ...
    type: "text",
    label: "업종",
    placeholder: "업종을 작성해주세요",
    required: true,
    enabled: true,
    order: 3,
  },
  {
    id: "custom_businessNumber",
    type: "text",
    label: "사업자등록번호",
    placeholder: "제조업일 경우 필수 작성",
    required: false,
    enabled: true,
    order: 4,
  },
  {
    id: "custom_annualRevenue",
    type: "text",
    label: "직전년도매출",
    placeholder: "전년도매출을 작성해주세요",
    required: true,
    enabled: true,
    order: 5,
  },
  {
    id: "custom_requiredFund",
    type: "text",
    label: "필요자금",
    placeholder: "필요하신 자금 규모",
    required: true,
    enabled: true,
    order: 6,
  },
  {
    id: "custom_preferredTime",
    type: "text",
    label: "상담희망시간",
    placeholder: "원하시는 시간을 남겨주세요",
    required: true,
    enabled: true,
    order: 7,
  },
